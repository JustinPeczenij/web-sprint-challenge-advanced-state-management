...
import { addSmurf, setFormError } from '../actions/'
...
const AddForm = (props) => {
    ...
    const  handleSubmit = e => {
        ...
        if (state.name === "" || state.position === "" || state.nickname === "") {
            props.setFormError("Name, position and nickname fields are required.");
        } else props.addSmurf({
            name:state.name,
...
export default connect(mapStateToProps, { addSmurf, setFormError })(AddForm);
